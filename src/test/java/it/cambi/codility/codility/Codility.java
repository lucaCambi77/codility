...
public class Codility
{
    ...
    /**
     * 
     * the elements at indexes 0 and 2 have value 9, the elements at indexes 1 and 3 have value 3, the elements at indexes 4 and 6 have value 9, the
     ...
     * 
     * that, given an integer N and a non-empty array A consisting of M integers, returns a sequence of integers representing the values of the
     * counters.
     */
    @Test
     ...
     * 
     * that, given a non-empty string S consisting of N characters and two non-empty arrays P and Q consisting of M integers, returns an array
    ...
    public void solveGenomicRange()
    {
        ...
        for (int i = 0; i < P.length; i++)
        {
            ...
            int toIndex = Q[i] + 1;
            /**
             * Controllo in ordine crescente, dal minore impatto al maggiore. Se c'è uno (o più) scalini di differenza vuol dire che c'è una di quelle
             * lettere
             */
