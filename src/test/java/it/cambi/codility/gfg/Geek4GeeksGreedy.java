...
public class Geek4GeeksGreedy {
	...
	public int firstElementToOccourKTime(String input, int freqToCheck) {
	...
	public String uncommonCharacters(String s1, String s2) {
	...
	public int sumOfNumberInString(String s) {
