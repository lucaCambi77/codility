...
public class LeetCodeHashMapTest {
    ...
    public void subdomainVisits() {
        ...
        result = Arrays.asList(new String[]{"901 mail.com", "50 yahoo.com", "900 google.mail.com", "5 wiki.org", "5 org", "1 intel.mail.com", "951 com"});
    ...
    private List<String> subdomainVisits(String[] cpdomains) {
        ...
        for (String cpdomain : cpdomains) {
            ...
            if (split1.length == 2) {
                domainMap.put(split1[0] + "." + split1[1], domainMap.getOrDefault(split1[0] + "." + split1[1], 0) + Integer.valueOf(split[0]));
                domainMap.put(split1[1], domainMap.getOrDefault(split1[1], 0) + Integer.valueOf(split[0]));
            } else {

                domainMap.put(split1[0] + "." + split1[1] + "." + split1[2], domainMap.getOrDefault(split1[0] + "." + split1[1] + "." + split1[2], 0) + Integer.valueOf(split[0]));
                domainMap.put(split1[1] + "." + split1[2], domainMap.getOrDefault(split1[1] + "." + split1[2], 0) + Integer.valueOf(split[0]));
